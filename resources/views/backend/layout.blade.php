...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="{{ asset('backend/vendor/font-awesome/css/font-awesome.min.css') }}" 
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Sesi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank.html">Senarai Sesi</a>
                                </li>
                                <li>
                                    <a href="blank.html">Tambah Sesi</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
